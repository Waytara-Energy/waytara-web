...
// width, so the (much wider) right cluster would out-grow a lopsided left
...
// breadcrumb and right cluster both get an explicit `col-start-*` for the
// same reason auto-placement can't be trusted here.
//
// SidebarTrigger sits at the left end — it also covers mobile, where the
// sidebar renders as a closed Sheet with no other way in, same click
// handler either way.
