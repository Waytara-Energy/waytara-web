 ...
 * because every client component on the page (live-polling charts, the
 * support chat) is about to start silently failing under RLS the moment
 * the browser's own session is actually gone; the customer needs to
